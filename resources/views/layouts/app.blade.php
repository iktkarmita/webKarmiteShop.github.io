...
<body id="page-top" style="background: rgb(196, 217, 245)">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- Topbar -->
            <nav class="navbar navbar-expand navbar-dark bg-gradient-dark topbar  static-top shadow "
                ...
                <div class="sidebar-brand-icon">
                    <a href="{{ url('/') }}">
                        <i class="fab fa-fw  fa-korvue text-white text-bold fs-4"
                            style="margin-right: 15px">armiteShop</i>
                    </a>
                </div>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- cart -->
                    <div class="cart mt-4">
                        <a class="cart mt-4 text-light" href="{{ url('/home/cart/shop') }}">
            ...
            <div id="wrapper">
                ...
                <!-- Sidebar - Brand -->
                <ul class="navbar-nav wy-nav-side shift sidebar sidebar-dark  accordion mainwrapper collapsed"
                    id="accordionSidebar"
